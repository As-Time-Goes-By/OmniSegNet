...
def get_parser():
    ...
    parser.add_argument('--bert_tokenizer', default='/data/zqc/huggingface-models/bert-base-uncased', help='BERT tokenizer')
    parser.add_argument('--ck_bert', default='/data/zqc/huggingface-models/bert-base-uncased', help='pre-trained BERT weights')
    ...
    parser.add_argument('--clip_value', default=0.01, type=float, help='max norm of the gradients.')
    ...
    parser.add_argument('--config-file', type=str, required=False, default='./configs/referring_swin_base2.yaml')
    ...
    parser.add_argument('--model_name', type=str, default=True)
    parser.add_argument('--fold', type=int, default=0, choices=[0, 1, 2, 3])
    parser.add_argument('--logpath', type=str, default='')
    parser.add_argument('--benchmark', type=str, default='gvpcoco', choices=['pascal', 'coco', 'gvpcoco'])
    return parser
