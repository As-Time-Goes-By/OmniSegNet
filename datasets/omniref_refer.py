...
class G_REFER:
    ...
    def __init__(self, data_root,image_root, split, dataset='OmniRef'):
        ...
        ref_file = f'{self.DATA_DIR}/OmniRef.json'
        instances_file=f'{self.DATA_DIR}/instances.json'
        self.data['refs'] = json.load(open(ref_file, 'rb'))[split]

        instances = json.load(open(instances_file, 'r'))[split]
