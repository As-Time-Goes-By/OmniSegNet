...
def get_parser():
    ...
    parser.add_argument('--config-file', type=str, required=False, default='./configs/referring_swin_base.yaml')
    parser.add_argument('--condition', type=str, default='mask', choices=['scribble', 'box', 'mask'])
    ...
    parser.add_argument('--benchmark', type=str, default='', choices=['pascal', 'coco'])
    return parser
