...
class RefCOCODataSet(Data.Dataset):
    def __init__(self, cfg,split,splitby):
        ...
        self.__C = cfg
        self.split=split
        assert cfg.DATASETS.DATASET_NAME in ['refcoco', 'refcoco+', 'refcocog','grefcoco']
        ...
        self.image_root='./datasets/coco2014/train2014'

        self.datadicts=load_grefcoco_json(cfg.DATASETS.REF_ROOT, cfg.DATASETS.DATASET_NAME, splitby, split, self.image_root, extra_annotation_keys=None, extra_refer_keys=None)
