...
def build_transformer_decoder(cfg, in_channels, mask_classification=True):
    ...
    MASK_FORMER_components = MultiScaleMaskedReferringDecoder.from_config(cfg, in_channels, mask_classification)
    MASK_FORMER = MultiScaleMaskedReferringDecoder(**MASK_FORMER_components)
    return MASK_FORMER
